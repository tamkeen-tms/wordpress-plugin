    ...
    <?php else: ?>
        <div id="category-courses" class="row row-cols-1 row-cols-md-<?php print esc_attr(get_option('tamkeen_grid_items_per_row', 3)) ?> g-4">
                ...
                <div class="col course">
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text extra-small text-muted"><?php print esc_html($course->description) ?></p>
